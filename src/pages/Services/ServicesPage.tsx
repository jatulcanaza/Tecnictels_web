    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-neutral-200 bg-white">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-14 md:py-20">
          <motion.div variants={stagger} initial="hidden" animate="show" className="max-w-3xl">
            ...
            >
              Soluciones en{" "}
              <span className="text-neutral-600">seguridad, redes y energía</span>{" "}
              para hogares y empresas.
            </motion.h1>

            <motion.p variants={fadeUp} className="mt-4 text-base text-neutral-700 md:text-lg">
              Implementamos infraestructura confiable: CCTV, alarmas, control de acceso, detección de incendios,
              cableado estructurado / data center, redes y telecomunicaciones, e instalaciones eléctricas con UPS y sistemas de tierra.
            </motion.p>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          >
            <motion.h2 variants={fadeUp} className="text-2xl font-bold tracking-tight text-neutral-950 md:text-3xl">
              Todos nuestros servicios
            </motion.h2>
            <motion.p variants={fadeUp} className="mt-3 text-sm text-neutral-700 md:text-base">
              ...
              {services.map((s) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p className="text-sm font-semibold text-neutral-950">{s.title}</p>
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <div className="mt-5 grid gap-4 sm:grid-cols-2">
                        <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-4">
                          <p className="text-xs font-semibold text-neutral-600">Incluye</p>
                        ...
                        <div className="rounded-2xl border border-neutral-200 bg-neutral-50 p-4">
                          <p className="text-xs font-semibold text-neutral-600">Ideal para</p>
                          <ul className="mt-2 list-disc pl-5 text-sm text-neutral-700">
                            {s.useCases.map((u) => (
                              <li key={u}>{u}</li>
                            ))}
